...
void VDAnimation::setTimeFactor(const int &aTimeFactor)
{
	...
	{
	case 0:
		shaderUniforms["iTimeFactor"].floatValue = 0.03125;
	...
	case 1:
		...
		break;
	case 2:
		shaderUniforms["iTimeFactor"].floatValue = 0.125;
		break;
	case 3:
		shaderUniforms["iTimeFactor"].floatValue = 0.25;
		break;
	case 4:
		shaderUniforms["iTimeFactor"].floatValue = 0.5;
		break;
	case 5:
		shaderUniforms["iTimeFactor"].floatValue = 0.75;
		break;
	case 6:
		shaderUniforms["iTimeFactor"].floatValue = 1.0;
		break;
	case 7:
		shaderUniforms["iTimeFactor"].floatValue = 2.0;
		break;
	case 8:
		shaderUniforms["iTimeFactor"].floatValue = 4.0;
		break;
	case 9:
		shaderUniforms["iTimeFactor"].floatValue = 16.0;
		break;
	default:
		shaderUniforms["iTimeFactor"].floatValue = 1.0;
		break;
